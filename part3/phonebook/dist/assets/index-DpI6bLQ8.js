  ...
  ma(function () {
    ...
    e: {
      ...
      if (h !== void 0) {
        ...
        0 < v.length &&
          ((h = new k(h, y, null, n, m)), f.push({ event: h, listeners: v }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        e: {
          ...
          switch (((h = t), (k = n), v.tag)) {
            ...
            case 0:
              if (
                ((y = v.payload),
                (h = typeof y == "function" ? y.call(k, f, h) : y),
                h == null)
              )
                break e;
              f = V({}, f, h);
...
function kp(e, t, n, r, l, o, i) {
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (o = Error(S(419))), (r = fo(o, r)), Or(e, t, i, r);
  }
...
function vl(e, t) {
  ...
  while (!0);
  if ((Hi(), (D = n), (ml.current = r), Y !== null)) throw Error(S(261));
...
const Ul = "/api/persons",
  ...
  dh = () => {
    const [e, t] = Be.useState([]),
      ...
      [s, a] = Be.useState(""),
      [m, f] = Be.useState(!1),
      [h, k] = Be.useState({ state: !1, message: "" });
    let y = [];
    const v = () => {
      f(!0),
        setTimeout(() => {
        ...
        c.preventDefault(),
          ...
          e.find((p) => p.name === n)
            ...
            : (t([...e, { name: n, number: l, id: `${e.length + 1}` }]),
              Dr.create({ name: n, number: l, id: `${e.length + 1}` }).then(
                () => {
                  v(), r(""), o("");
                }
              ),
